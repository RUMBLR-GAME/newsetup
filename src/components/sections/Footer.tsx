...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-white/[0.06] pt-16 pb-12 px-6 md:px-8 lg:px-20">
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li><a href="#card" className="hover:text-white transition-colors">Card</a></li>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li><a href="https://x.com/fluidpayments" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Twitter / X</a></li>
              <li><a href="mailto:hello@fluid.au" className="hover:text-white transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-xs text-white/55 leading-relaxed">
              Fluid is a Solana Frontier Hackathon project (May 2026). AUDD is real
              and issued by AUDC Pty Ltd under an AFSL granted by ASIC. AUDC is
              registered with AUSTRAC and is a member of AFCA. Fluid is pursuing
              its own AFSL pathway ahead of the June 2026 ASIC no-action expiry.
              Nothing on this page is financial advice — get advice for your
              situation.
            </p>
          </div>
        </div>
