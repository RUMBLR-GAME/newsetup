...
const PhoneMockup = dynamic(() => import("../PhoneMockup"), {
  ...
  loading: () => (
    <div
      aria-hidden
      className="w-[300px] h-[612px] rounded-[54px] bg-white/[0.02] border border-white/[0.04]"
    />
  ),
});
...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative pt-28 md:pt-36 lg:pt-40 pb-20 md:pb-24 lg:pb-28 px-6 md:px-8 lg:px-20 overflow-hidden"
    >
      {/* Mint glow at top */}
      <motion.div
        aria-hidden
      ...
      <div className="container-fluid relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <motion.div
            ...
            className="lg:col-span-5 relative h-[500px] lg:h-[700px] hidden md:block"
          >
            <PhoneMockup />
          </motion.div>
        </div>
